...
const Hero = () => {
    ...
    return (
        <div className='flex flex-col sm:items-center gap-[8px] sm:gap-[20px] text-center px-[16px] sm:py-[100px] sm:px-[120px] gradient'>
            <h1 className='text-[22px] sm:text-[length:var(--heading-h1)] font-bold'>Transparent and Simple Pricing</h1>
            <p className='text-[#71717A] sm:text-[18px] text-[13px] sm:max-w-[45%]'>Select from best plans, ensuring a perfect match. Need more or less? Customize your subscription for a seamless fit! </p>
